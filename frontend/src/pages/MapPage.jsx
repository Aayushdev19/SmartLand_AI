...
const MAP_CENTER = [22.3119, 73.1723];
...
export default function MapPage() {
  ...
  return (
    <div className="sl-map-container" style={{ display: 'flex', height: '100vh', paddingTop: 56, position: 'relative' }}>
      <aside className="sl-map-sidebar" style={{ width: 200, background: '#fff', borderRight: '1px solid #E2E8F0', display: 'flex', flexDirection: 'column', flexShrink: 0, zIndex: 10 }}>
