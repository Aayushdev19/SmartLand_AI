...
export default function DashboardPage() {
  ...
  return (
    <div className="sl-dash-layout" style={{ display: 'flex', minHeight: '100vh', paddingTop: 56, background: '#F0F2F5' }}>
      <aside className="sl-dash-sidebar" style={{ width: 200, background: '#fff', borderRight: '1px solid #E2E8F0', display: 'flex', flexDirection: 'column', position: 'fixed', top: 56, bottom: 0, left: 0, zIndex: 10 }}>
      ...
      <main className="sl-dash-main" style={{ marginLeft: 200, flex: 1, padding: '40px 36px', minHeight: '100vh', width: '100%' }}>
        {tab === 'Overview' && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, ease }}>
            ...
            <div className="sl-dash-kpi" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 24 }}>
              {[
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {predictions.slice(0, 3).map(p => (
                    <div key={p.id} className="sl-card" style={{ padding: '14px 18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
                      <div>
        ...
        {tab === 'History' && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, ease }}>
            ...
            {predictions.length === 0 ? (
              ...
              <div className="sl-card table-responsive">
